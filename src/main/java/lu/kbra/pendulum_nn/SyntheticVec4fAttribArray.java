...
public class SyntheticVec4fAttribArray extends Vec4fAttribArray {
	...
	public SyntheticVec4fAttribArray(String name, int index, int dataLength, boolean _static, int divisor) {
		super(name, index, null, _static, divisor);
		super.length = dataLength;
	}

	public SyntheticVec4fAttribArray(String name, int index, int dataLength, boolean _static) {
		super(name, index, null, _static);
		super.length = dataLength;
	}

	public SyntheticVec4fAttribArray(String name, int index, int dataLength, BufferType bufferType, boolean _static,
			int divisor) {
	...
	public SyntheticVec4fAttribArray(String name, int index, int dataLength, BufferType bufferType) {
		super(name, index, null, bufferType);
		super.length = dataLength;
	}

	public SyntheticVec4fAttribArray(String name, int index, int dataLength) {
