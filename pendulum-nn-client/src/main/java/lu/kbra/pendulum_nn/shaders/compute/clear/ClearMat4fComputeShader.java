...
public class ClearMat4fComputeShader extends ComputeShader {

	public static final String ELEMENT_COUNT = "elementCount";

	public ClearMat4fComputeShader() {
		super(new ComputeShaderPart("classpath:/shaders/clear_mat4f.comp"), new Vector3i(256, 1, 1));
	}
